package com.absolutehh.app.views.access;
...
@Route(value = "access", layout = MainView.class)
@PageTitle("Access")
@CssImport("./styles/views/access/access-view.css")
...
public class AccessView extends Div {
    ...
    public AccessView(@Autowired PersonService personService) {
        setId("access-view");
